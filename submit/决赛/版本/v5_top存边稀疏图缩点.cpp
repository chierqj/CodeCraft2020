...
#ifdef LOCAL
#define TRAIN "../data/debug/test_data.txt"
#define RESULT "../data/debug/result.txt"
#else
...
struct RadixHeapUShort {
  ...
  inline static constexpr int pos(ushort x) {
