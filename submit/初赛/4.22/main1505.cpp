...
class XJBG {
 ...
 public:
  static const int MAXN = 50000 + 7;  // 总点数
  static const int NTHREAD = 8;       // 线程个数
  // const int PARAM[NTHREAD] = {7, 8, 13};  // 线程权重
  const int PARAM[NTHREAD] = {3, 2, 3, 5, 4, 8, 13};  // 线程权重
  const int PARAM_SUM = 100;
...
void XJBG::ParseInteger(int val) {
  int x = val;
